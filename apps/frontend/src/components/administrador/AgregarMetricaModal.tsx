...
interface AgregarMetricaModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
  token: string;
...
export function AgregarMetricaModal({ isOpen, onClose, onSuccess, token }: AgregarMetricaModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Error al crear la métrica');
      }
      ...
      <div className="modal-container" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div className="modal-title">
            ...
            <h2>Agregar Nueva Métrica Clínica</h2>
          </div>
            ...
            <div className="form-grid">
              <div className="form-field full-width">
                ...
                <small style={{ fontSize: '0.7rem', color: 'var(--text-secondary)' }}>
                  Nombre descriptivo que identifique la métrica
                </small>
              </div>
              ...
              <div className="form-field full-width">
                ...
                />
                <small style={{ fontSize: '0.7rem', color: 'var(--text-secondary)' }}>
                  Información adicional sobre la métrica (opcional)
                </small>
              </div>
            </div>
          </div>
